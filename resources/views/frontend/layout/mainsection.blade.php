...
<head>
    ...
    <title>Cosmio</title>
    <!-- FAVICON -->
    <link rel="shortcut icon" type="image/png" href="{{asset('FrontEnd/assets/img/favicon.ico')}}" />
    <!-- BOOTSTRAP CSS-->
...
<body>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-3" >
                       ...
                       <div class="logo" >
		<img height="70px" width="10px" style="padding-right: 20px"  src="{{asset("storage/logo/$logos->logo")}}" >
    </div>
		@endforeach
                        <!-- END LOGO -->
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="single-team text-center">
                        <img src="{{asset("storage/team/$teams->team")}}" alt="" class="img-responsive" />
                ...
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="footer-widget">
                            <h4 class="footer-logo">about <span>Cosmio</span></h4>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="footer-text text-center">
                        <p class="text-muted"><span>CosmioInfo</span> &copy;2017 - All Right Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- GOOGLE MAP JS -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyChJoxGL2coqWo3NdVla4EFmaKP6KXtxI0"></script>
